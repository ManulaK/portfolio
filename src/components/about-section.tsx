				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 md:gap-12 items-center mb-16 min-h-0">
					...
					>
						...
						<div className="flex flex-wrap gap-4 pt-4">
							<div className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Full-Stack Development</div>
							<div className="px-4 py-2 bg-purple-100 rounded-full text-sm font-medium">Cloud Architecture</div>
							<div className="px-4 py-2 bg-green-100 rounded-full text-sm font-medium">UI/UX Design</div>
							<div className="px-4 py-2 bg-orange-100 rounded-full text-sm font-medium">DevOps</div>
						</div>
					</motion.div>
				</div>
